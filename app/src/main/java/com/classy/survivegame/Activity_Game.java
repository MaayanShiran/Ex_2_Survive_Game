...
public class Activity_Game extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("MAAYA12", "this is the id: " + id + " this is the state: " + getIntent().getStringExtra(EXTRA_STATE));
    ...
    public void arrowClicked(int direction) {
        Log.d("MAAYA12", "this is the current direction: " + direction);
        Log.d("MAAYA12", "this is the step: " + this.steps[this.currentLevel]);
    ...
    private void finishGame() {
        ...
        if (this.goodToGo) {
            Toast.makeText(this, "Survived in " + state, Toast.LENGTH_LONG).show();//dur 1
        } else {
